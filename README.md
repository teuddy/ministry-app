...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/npgFXUB9aU)
...
```sh
npx nx serve ministryapp
```

To create a production bundle:

```sh
npx nx build ministryapp
```

To see all available targets to run for a project, run:

```sh
npx nx show project ministryapp
```
